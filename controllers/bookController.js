...
exports.book_create_post = function (req, res, next) {
  ...
  body('author', 'Author must not be empty').notEmpty().trim().escape();
  body('summary', 'Summary must not be empty').notEmpty().trim().escape();
  body('isbn', 'ISBN must not be empty').notEmpty().trim().escape();
...
exports.book_delete_post = function (req, res) {
  ...
  body('id', 'Book id must exist').notEmpty().trim().escape();
